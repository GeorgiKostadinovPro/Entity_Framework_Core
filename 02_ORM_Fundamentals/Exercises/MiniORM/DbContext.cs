    ...
    public void SaveChanges()
    {
        ...
        foreach (IEnumerable<object> dbSet in dbSets)
        {
            ...
            if (invalidEntities.Any())
            {
                throw new InvalidOperationException(
                    string.Format(ExceptionMessages.InvalidEntitiesException,
        ...
        using (new ConnectionManager(this.connection))
        {
            ...
            foreach (IEnumerable dbSet in dbSets)
            {
                ...
                {
                    // No need for rollback beacuse the Persist<T> method was never invoked!
        ...
        foreach (PropertyInfo foreignKey in foreignKeys)
        {
            ...
            foreach (TEntity entity in dbSet)
            {
                ...
                object navigationPropertyValue = navigationDbSet
                    .First(cnpv => navigationEntityPrimaryKey.GetValue(cnpv).Equals(foreignKeyValue));
